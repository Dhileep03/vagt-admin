    ...
    >
      <div className="flex flex-col items-start gap-4 px-2 py-5 relative">
        <button
          ...
          className="group absolute top-20 -right-3 transform -translate-y-1/2 bg-primary text-primary-foreground rounded-full p-2 shadow-md hover:bg-primary-dark transition-colors"
        >
          {isExpanded ? (
